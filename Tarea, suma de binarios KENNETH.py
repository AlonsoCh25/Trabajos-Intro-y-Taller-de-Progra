...
def sumarBinarios(numero1, numero2):
    ...
    if isinstance(numero1, list) and isinstance(numero2, list) and (len(str(numero1)) == len(str(numero2))):
...
def sumarAux(numero1, numero2, exp):
    ...
    if numero1 == 0:
        ...
        return (numero1[:-1] + numero2[:-1])*(2**exp) + sumarAux(numero1//10, numero2//10, exp+1)
